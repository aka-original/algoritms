...
for i in A:
    ...
    for k in range(5):
        A[k]=A[k]*3
    '''
    # A=[0]*1000 - создаст пустой массив на 1000 элементов эквивалентно записи A = [0] + [0] + [0] ... 1000 раз
    # отсюда следуюет что списки можно складывать A = B + C - создастся новый список А, где В и С 2 разных списка 
